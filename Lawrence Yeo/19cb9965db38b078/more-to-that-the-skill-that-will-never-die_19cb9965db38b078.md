---
id: "19cb9965db38b078"
subject: "More To That: The skill that will never die 🌲"
from: "Lawrence Yeo <contact@moretothat.com>"
to: ""
date: 2026-03-04 16:02:44
labels: ["CATEGORY_PERSONAL", "INBOX", "Lawrence Yeo", "UNREAD"]
label_ids: ["CATEGORY_PERSONAL", "INBOX", "Label_3631958563782906958", "UNREAD"]
---
Tomorrow’s the last day to enroll in Thinking In Stories. There are students across 5 different countries (!) currently in the cohort, and it’s shaping up to be a great one.
Not only will Thinking In Stories give you a toolkit you can use for any story you want to tell, you can also see it as a 4-week refresher to your creative practice. If you struggle with generating ideas, connecting them, or organizing them into a narrative, then this program will help you break through those barriers and provide a fresh start.
Once enrollment closes up, I don’t know when I’ll offer the program again. So if you’ve been wanting to take the course, this is the time to do it:
For the rest of today’s newsletter, I want to discuss what the future of the creative landscape looks like, especially as AI continues its reign. As someone who thinks a lot about creativity and what it means to embody it, it’s becoming clear to me that future-proofing oneself is so important. And as it turns out, there’s one evergreen skill that will fulfill this role going forward.
There’s a lot to go over, so when you’re ready, let’s dive right in.
*Note: You can read the whole piece on the site here.
Like many of you, I’ve been experimenting with AI. I’ve been using ChatGPT to summarize my favorite books, been using Claude as an ideation partner, and have been building apps with Claude Code as well.
...
You might think storytelling is reserved for fictional beasts and magical wizards. Far from it. Storytelling is embedded in everything we do, ranging from a client meeting, a job interview, a breaking news story, to even this very newsletter you’re reading right now. Each of these scenarios contains a narrative that is being communicated, and the way it’s framed will determine whether or not it achieves its desired outcome.
For example, I’m writing this newsletter to tell you about the importance of storytelling, and will go into some practical techniques to go about it. Now, I could’ve started it off by simply saying, “I think storytelling is an extremely important skill for you to learn. Here’s how to cultivate it.” But that would merely be information, which would read like something ChatGPT might say. Instead, I started it off with an anecdote about how I’ve been using AI, some of the concerns I’ve had about it, along with a brief discussion about Marshall McLuhan’s work and a Steve Jobs quote as well.
...
That's it for today's post. February was full of storytelling insights, and March is for those that are looking to dive deeper into the evergreen skill that will forever be relevant.
Enrollment for Thinking In Stories ends tomorrow, and that'll be it. Join today to secure a spot in the cohort while you still can.