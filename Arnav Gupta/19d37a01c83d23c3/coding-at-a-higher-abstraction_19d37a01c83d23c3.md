...
This is why debating “real programmers” vs “vibe coders” feels played out. [GitHub’s 2023 survey](https://substack.com/redirect/c36bf337-7e03-4076-9578-848c9dc91200?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) already called AI tools mainstream. Fast forward to 2025, [Stack Overflow’s survey](https://substack.com/redirect/69fbd8e0-42a7-47db-b247-681343f2a04c?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) shows almost everyone is using or planning to use them. The big players aren’t hiding it either—[Google admitted over 25% of their new code is AI-generated](https://substack.com/redirect/e7322307-569c-471b-af69-229ccd5314a8?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o), and [YC is seeing startups with 95% AI-written codebases](https://substack.com/redirect/fa0b12ca-5c5e-405f-a235-23651c99ef90?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o).
...
And this isn’t some futuristic hypothetical. [Anthropic already pushes Claude Code as the “first stop”](https://substack.com/redirect/bd4eb015-5a96-4080-9c8e-bfd3773523e5?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) for eng tasks. [GitHub is pushing agent-mode hard](https://substack.com/redirect/02546099-cf37-4c8f-a299-c54583367226?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) so the AI just loops until the job is done. Even [Google’s Jules tool](https://substack.com/redirect/0c25a52a-a619-4a98-bb4a-40ff5f16288e?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) straight-up assumes developers just live in the terminal now.
When that shift happens, something weirdly subtle disappears: the file itself isn’t your main workspace anymore.
It sounds like a minor detail, but it changes your entire relationship with the codebase. You aren’t molding the code line by line anymore. Instead, you’re describing what you want, setting boundaries, and checking the results. Sure, sometimes you step in and fix things manually. But if you start micromanaging the AI—getting mad about camelCase
vs under_scores
, or where a private helper method sits—you completely lose the massive speed boost this whole workflow gives you.
This is why I think the term “vibe coding” is kind of funny but also misleading. Karpathy’s joke hit hard because we’ve all been there. But [as Simon Willison pointed out](https://substack.com/redirect/c81c3f47-f2e7-4cac-8731-8d4ed8615520?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o), not all of this is just blindly riding the vibes. There’s a serious version of this workflow where you actually understand the system, you write tests, you jump in when needed, and you own the final outcome—even if you didn’t physically type every single character yourself.
...
I felt this hard when I was messing around with some side projects recently. One was a CLI tool to sync .env
files across my laptops. I hacked together an ugly prototype in bash first, and then wrote a lot of end to end tests for it. All of it with lots of help from AI ‘generating’ the code, but I did it all from a proper IDE. Then I let the AI rewrite the whole thing in Go while I just kept the test suite green. I just wanted to see what a cross-language rewrite feels like when the machine does the heavy lifting. Another project was a 2FA app where, using agents, I shipped clients for web, CLI, desktop, iOS, Android, Apple Watch, and Wear OS in a fraction of the time it would normally take me to hand-code all those different platforms.
Now, before anyone gets defensive, let’s be real: this doesn’t mean your enterprise day job is suddenly 100x faster. [METR did a great study on experienced devs working on open-source repos](https://substack.com/redirect/51fc0ad8-fe8b-4816-a624-be1e116f5b93?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) and found that on gnarly, mature codebases, AI can actually slow you down. Legacy code has weird edge cases, migration headaches, and a ton of review overhead. AI doesn’t magically make that baggage disappear.
...
You can see this shift everywhere. [Addy Osmani’s workflow](https://substack.com/redirect/520b9a7e-a334-43d0-8e1b-3f5df7589cf7?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) is all about spending time on specs and architecture. [Les Orchard’s routine](https://substack.com/redirect/e306a24d-94b8-4894-8b87-cea878a0cb36?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) literally boils down to writing a spec.md
, generating a plan.md
, letting the agent loose, and then reviewing the PR. [Simon Willison nailed it](https://substack.com/redirect/e4c52283-9e66-48c7-9d07-20ed0a1ecfa8?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) when he said it feels like managing a super fast but overconfident intern. You just have to tell them exactly what to do.
...
But if I write tests first—asserting the cookie is HttpOnly
, the expiry works, cross-origin requests behave correctly—I suddenly have a hard boundary. I’m controlling the exact outcome instead of micromanaging the syntax.
Honestly, this makes Test-Driven Development (TDD) way more relevant now. Not because the old TDD evangelists were right all along, but because automated tests are literally the only way to steer an AI that writes code unpredictably. [Anthropic spells this out](https://substack.com/redirect/e1ddf4fa-3f74-436b-971d-1853d4f00e6d?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o)—evals are just tests for AI. [OpenAI’s docs](https://substack.com/redirect/c2ecd475-cfc2-4605-a51e-2d82497a62ee?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) say the exact same thing. We don’t care if the code looks pretty; we care if the system does what it’s supposed to do.
...
You can see the whole industry pivoting this way. [GitHub’s agent docs](https://substack.com/redirect/cc195f23-0895-408b-97a3-b262a90e3949?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) and [their product updates](https://substack.com/redirect/46765828-7279-4a03-9a96-821708afb155?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) are entirely focused on isolated sandboxes, automated checks, and PR reviews. [Hamel Husain has been shouting about “evals over vibes”](https://substack.com/redirect/716028cc-9851-4c47-a1ef-0acfebed3ad7?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) for ages. Even [Martin Fowler’s take on GenAI patterns](https://substack.com/redirect/363da73a-f2c1-4079-a0cd-1e1e21f868ed?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) hits the same point: when the AI is non-deterministic, “vibes” aren’t enough. You need hard checks.
...
I was building that .env
sync tool I mentioned earlier. The idea, fairly simple: sync secrets across my Mac, Windows, and Linux boxes over my local network without hitting a cloud server. I told the agent the core requirements: LAN peer discovery, conflict resolution, use existing SSH keys.
...
This is exactly what [Addy Osmani means by the “70% problem”](https://substack.com/redirect/7847b1e6-282e-4beb-9cd3-b4feab5e4bb1?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o). That first 70% feels like magic. But the last 30% is where the real engineering, edge cases, and architecture happen. It’s also why [GitClear’s report on AI code quality](https://substack.com/redirect/139ce71f-7524-46e4-8b29-f1a4a1654666?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) is kind of scary—AI is great at churning out code, but terrible at refactoring and reflection. And [Thoughtworks was right to warn us](https://substack.com/redirect/38da602b-4250-4ccc-9969-5cbbf9313eb6?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o): AI can definitely help you build the wrong thing much faster.
...
Throw an AI agent into the mix, and suddenly a single dev can tackle a massive chunk of work. [Anthropic’s internal research](https://substack.com/redirect/4aafd08c-2068-41c4-9850-4a08ad4d8027?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) showed that AI isn’t just speeding up work—it’s empowering devs to take on massive refactors they wouldn’t have even bothered attempting before. The scope of “what’s worth doing” is expanding.
That doesn’t mean we just 3x the size of everyone’s Jira tickets. That’s a terrible idea (again, [see METR’s study](https://substack.com/redirect/51fc0ad8-fe8b-4816-a624-be1e116f5b93?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o)). It just means we need to recalibrate how we map seniority, task size, and review time.
...
Sure, AIs are already doing code reviews. [GitHub says Copilot has done tens of millions of them](https://substack.com/redirect/69e221b7-a71b-496d-aa50-4ac6cae08ec3?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o). Having an AI do a first-pass review is super helpful. But the real shift isn’t just using AI to read more lines of code. It’s about humans reviewing different things entirely.
