---
id: "17d458133b755902"
subject: "Buy now, worry later: the Indiabulls Dhani spin on lending"
from: "The Ken <info@the-ken.com>"
to: ""
date: 2021-11-22 02:37:12
labels: ["CATEGORY_PERSONAL", "INBOX", "The Ken", "UNREAD"]
label_ids: ["CATEGORY_PERSONAL", "INBOX", "Label_8244464457792971031", "UNREAD"]
---
Today's story is about a buy-now-pay-later product. But a rather unique one.
It comes with a 0% interest rate for credit up to Rs 5 lakh (~$6,700). But there are some conditions: you have to pay a monthly subscription fee; you can use only 10% of the credit line per day; and when you make a transaction, you have to pay back in three instalments over 60 days, no matter how small the amount.
...
If you're wondering what doctors and medicines are doing on a BNPL app, you're not alone.
But this is the unique premise of OneFreedom, a transaction finance product that has put a spin on the age-old business of giving credit. It was launched in January by Dhani Services, the lending arm of the financial services conglomerate Indiabulls Group.
