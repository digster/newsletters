---
id: "19d44d8496d87ce6"
subject: "What is inference engineering? Deepdive"
...
---
|
Two years ago, we learned about [how LLMs work](https://substack.com/redirect/d8aebe68-3548-45d2-b01c-27506cd641e0?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) at a high level from [the ChatGPT team](https://substack.com/redirect/d8aebe68-3548-45d2-b01c-27506cd641e0?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o), and today, almost all software engineers use large language models (LLMs) in our day-to-day work. The most visible part of using an LLM is inference; when an existing model takes an input (prompt) and generates an output, one token at a time. So, with AI models and AI agents everywhere across the tech industry in 2026, that means so is inference.
And now, inference engineering is becoming more widespread, too, as open LLM models grow more capable. This is because with closed models, inference engineering is done only by the AI engineers who build the model, whose number might add up to a few thousand globally. In contrast, with the open models which tech companies are adopting, it’s possible to tweak them to perform better at inference. For example, Cursor built its new Composer 2.0 model [on top of](https://substack.com/redirect/b0e2b69f-ec8d-487f-ba34-8b8b1522a5fc?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) the open Kimi 2.5 model, and successfully used plenty of inference engineering approaches to make it even faster.
...
KV cache: key-value cache. The cached results of the attention algorithm, reused between requests to speed up inference. We cover more on KV cache in the
[Scaling ChatGPT deepdive](https://substack.com/redirect/e6d7f625-8049-43cc-bfd1-f0d507e878ae?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o).Prefill / decode: the two phases of inference. Prefill is when the model takes the full input and processes tokens, outputting the KV cache. Decode is the phase in which the model generates one token at a time.
MoE: Mixture of Experts. An architecture that enables models to be pretrained with far less compute.
[More details on this approach.](https://substack.com/redirect/b00061e4-9f0e-4da3-839f-bb9561630380?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o)
Below is an introduction to inference adapted from Philip’s book, “Inference Engineering,” which is [free to download as an e-book](https://substack.com/redirect/0cd0f2c6-d54d-42a8-bcab-65fafd0b738c?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o). Physical copies are currently sold out, but Philip is printing more as fast as possible.
My usual disclaimer: as with all my recommendations, I was not paid to mention this book, and no links in this article are affiliates. See my [ethics statement](https://substack.com/redirect/f5551e55-5648-46dd-9551-f0171aca6aa6?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) for more.
...
Three years later, it turns out that training generative AI models is indeed both hard and expensive – but it’s not so hard and expensive to be limited to a handful of players. Instead, a proliferation of open models – more than two million and counting on [Hugging Face](https://substack.com/redirect/bf1bea5e-14d1-4e5f-9c7d-acc92bb99321?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) (the “GitHub for AI”) – means that today every engineer can now deploy their own intelligence to power AI products.
...
Before December 2024, there was a meaningful gap in intelligence between closed and open models, but when DeepSeek V3 and R1 were released, that gap disappeared. Note from Gergely: we previously covered [how DeepSeek’s release rocked the AI industry.](https://substack.com/redirect/0e2e411b-3ef0-4464-99fc-8558d98f731e?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o)
...
Datacenter GPUs like the [NVIDIA B200](https://substack.com/redirect/36d845ee-5eeb-42a1-8078-808b6b019c7c?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) offer the highest individual performance, and more importantly, include high-bandwidth GPU-to-GPU interconnects, are installed in highly standardized configurations, and are available by the millions in datacenters worldwide.
...
[transformers](https://substack.com/redirect/b5cf862e-864f-4853-b712-2a54258c88e0?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o)(models built on the[transformer architecture](https://substack.com/redirect/d45ad182-e703-44fc-8e88-6647cc002712?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o)), and[diffusers](https://substack.com/redirect/403d93b8-8831-4368-aea3-841ac6a5f811?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o)(models built on the[diffusion-based](https://substack.com/redirect/1c0fc910-29bb-45eb-917c-3bc4713848c1?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o)generative ones).The Linux Foundation: Maintains hardware-agnostic projects like PyTorch and vLLM.
...
Models are trained with weights, activations, and other components represented in a certain native number format. Usually, this is [BF16](https://substack.com/redirect/a593b652-231f-44e7-bc93-d25050101981?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) or [FP16](https://substack.com/redirect/afc54954-0ea2-41a1-935e-4f78d30898d1?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o), although 8-bit and 4-bit native precisions are becoming more popular for training.
...
This is Gergely again. Thanks to [Philip](https://substack.com/redirect/efea12e3-2661-4f9e-96bb-4c29efdcd295?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) for this deepdive into inference engineering, which is around 10% of the contents of his new book, ”Inference Engineering.” If you’d like to go deeper into this topic, you can download the full book for free:
This title will also be available in physical, printed form: sign up to the [waitlist](https://substack.com/redirect/ec38cc06-e9be-4c96-8b4c-9f25e199d775?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) to be notified when it’s available.
...
You’re on the free list for [The Pragmatic Engineer](https://substack..Cu1J3krzigauR-RV5ouJybjwTPBUcam5jBPQ2-vg7TQ?). For the full experience, [become a paying subscriber](https://substack.com/redirect/2/eyJlIjoiaHR0cHM6Ly9uZXdzbGV0dGVyLnByYWdtYXRpY2VuZ2luZWVyLmNvbS9zdWJzY3JpYmU_.OkD2qOgDx-SZzwRPAaVSqdkEKfayJcvwX5WCkG-YhvM?). Many readers expense this newsletter within their company’s training/learning/development budget. If you have such a budget, here’s[ an email you could send to your manager](https://substack.com/redirect/23af9b9b-441d-4b4c-adf5-f8136140f7a8?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o).
This post is public, so feel free to share and forward it.
If you enjoyed this post, you might enjoy my book, [The Software Engineer's Guidebook](https://substack.com/redirect/14cb1cfa-31ae-4471-9823-bfa98d7b60a0?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o): navigating senior, tech lead, staff and principal positions at tech companies and startups.