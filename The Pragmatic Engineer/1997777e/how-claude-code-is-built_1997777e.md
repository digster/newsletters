...
I recently sat down with two of the founding engineers behind Claude Code: [Boris Cherny](https://substack.com/redirect/2eb40ba9-9332-4b66-868b-1f755babb1ba?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) (the engineer who came up with the original prototype, and the founding engineer of the project), [Sid Bidasaria](https://substack.com/redirect/c3b9b97e-572a-41e0-8815-d9edc8a9111d?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) (engineer #2 of Claude Code, and creator of Claude Code subagents), and founding product manager [Cat Wu](https://substack.com/redirect/1cf13e59-b80b-4501-b94e-2bc672d9ef58?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o).
...
Today, we cover:
How it all began. The idea for Claude Code came from a command-line tool using Claude to state what music an engineer was listening to at work. It spread like wildfire at Anthropic after being given access to the filesystem. Today, Claude Code has its own fully-fledged team.
Tech stack and architecture. TypeScript, React, Ink, Yoga, and Bun. The tech stack was chosen to be “on distribution” and to play to the strengths of the model. Fun fact: 90% of code in Claude Code is written by itself!
Building and shipping features in days – not weeks. The team is working at rapid pace, with around 5 releases per engineer each day. Prototyping is done surprisingly quickly: we go through 10+ actual prototypes for a new feature. It looks like AI agents really speed up iteration.
Redesigning the terminal UX. Claude Code brings a lot of innovative features to the terminal user experience that weren’t needed before we could interact with terminals powered by LLMs. A look at some of them.
What “AI-first” software engineering looks like. Using AI agents for code reviews and tests, test-driven development’s (TDD) renaissance, automating incident response, and cautious use of feature flags. Does this presage how “AI-first” engineering teams will work in the future?
Building subagents. A walk through how the subagents feature was built in just three days, of which two days’ work was thrown away.
Future of AI-assisted engineering teams? What engineering teams can learn from how Anthropic operates, and things to keep in mind about what makes it unique, that might be less transferable.
Other, related deepdives from the [real-world engineering challenges series](https://substack.com/redirect/15c57260-64a1-4257-a616-6749bf1d0785?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o):
The bottom of this article could be cut off in some email clients. [Read the full article uninterrupted, online.](https://substack.com/redirect/ce45c570-6704-4695-97b1-dd34c9ca126d?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o)
...
“I started hacking around using Claude in the terminal. The first version was barebones: it couldn't read files, nor could it use
[bash], and couldn’t do any engineering stuff at all. But it could interact with the computer.I hooked up this prototype to AppleScript: it could tell me what music I was listening to while working. And then it could also change the music playing, based on my input.
...
The team grew to around 10 engineers by July, and hiring has continued since. Today, it’s a full-fledged product team with engineers, Product Management, Design, and Data Science folks – and they’re [still hiring](https://substack.com/redirect/14426218-923c-4746-a26c-8e092fa7a0d5?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o).
...
React with Ink: the UI is written in React, using the
[Ink](https://substack.com/redirect/e5e6e01f-b970-4c07-b7e2-b5faa830666f?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o)framework for interactive command-line elements[Yoga](https://substack.com/redirect/3fa5f9e1-d514-4b69-9e27-3df852c6570f?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o): the layout system, open sourced by Meta. It’s a constraints-based layout that works nicely. Terminal-based applications have the disadvantage of needing to support all sizes of terminals, so you need a layout system to do this pragmatically[Bun](https://substack.com/redirect/5125fce7-fa25-477e-abc3-93a5c48bf1ac?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o): for building and packaging. The team chose it for speed compared to other build systems like Webpack, Vite, and others.
...
Claude Code is simple in some ways, but has dozens of features which add to its complexity. Several are [documented](https://substack.com/redirect/0ea47677-df1c-48a8-86b2-f7194f3f7be6?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o). Some to note:
[Hooks](https://substack.com/redirect/5836292b-a600-4ba5-957a-84eddf4cee16?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o): create custom shell commands for Claude Code to use[MCP support](https://substack.com/redirect/389c4e65-8a3e-4d3c-8f84-5fe296193951?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o): give Claude Code more capabilities by connecting it to MCP servers. See our deepdive on the Model Context Protocol (MCP)[GitHub](https://substack.com/redirect/9a51baaa-14c1-40ff-ada5-fcc84d300021?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o)and[GitLab](https://substack.com/redirect/75fd1576-8378-40ba-956f-d6d88dfabfaa?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o)support: use GitHub Actions and integrate Claude Code into GitLab CI/CD.[Output styles](https://substack.com/redirect/4f3da706-b929-495c-9924-c04ddf493b31?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o): the ability to switch to output styles, or define your own. Built-in output styles you can switch to include:Explanatory: educating you about implementation choices
...
[Configuration](https://substack.com/redirect/91122339-bf86-43c0-a1e6-7db31d7d19e2?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o): use a variety of config files and settings to configure your terminal, model, status line, and many more[Subagents](https://substack.com/redirect/3ab2354f-9355-456e-bda6-83b67126aa67?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o): covered belowEnterprise features:
[set up](https://substack.com/redirect/6dc854c6-1cce-4775-b72c-5131d06db3d8?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o)Identity and Access Management (IAM) to use Claude Code across an organization, and access[org-wide analytic](https://substack.com/redirect/95fb4e8a-3760-418f-8283-911530602290?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o)s to track usage[Claude Code SDK](https://substack.com/redirect/8737ad01-998e-48ea-bc2b-7093fa06e76d?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o): build custom AI agents, using the agent harness that powers Claude Code… and see this roundup of
[recent new features in Claude Code](https://substack.com/redirect/f8151adc-7259-43ff-b433-3ea7013a2e07?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o)
...
A lot of this prototyping was about making the UI “feel good:” You can see the animated prototypes [in this thread](https://substack.com/redirect/52111b4e-a8f6-4a8e-97f8-169d165fc032?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o). I suggest watching the videos of the prototype steps for a sense of how the feature evolved, and how Boris kept trying new ideas to narrow it down to how the todo list looks inside the tool today.
