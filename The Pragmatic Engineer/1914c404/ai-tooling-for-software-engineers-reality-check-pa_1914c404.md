---
subject: "AI Tooling for Software Engineers: Reality Check (Part 2)"
from: "The Pragmatic Engineer <pragmaticengineer+deepdives@substack.com>"
to: ""
date: 2024-08-13 14:58:30
...
Our survey on this topic was filled out [by 211 tech professionals](https://substack.com/redirect/195a453e-c3e9-41ae-aa70-8b9d8fa10098?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o); and we then analyzed this input to offer a balanced, pragmatic, and detailed view of where LLM-powered development tooling stands, right now.
[In Part 1 of this mini series](https://substack.com/redirect/630d0d92-d8b7-4101-b0da-e10b175e2643?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) we covered:
Survey overview
...
The bottom of this article could be cut off in some email clients. [Read the full article uninterrupted, online](https://substack.com/redirect/3b52a1e4-e773-4de7-bb03-e8f24d7d8e23?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o).
...
“Still learning how to use it.” It takes time and experimentation to figure things out. Software engineer Simon Willison (25+ YOE, the creator of the Django framework) has [publicly said](https://substack.com/redirect/c546e50c-91bb-408e-a1f0-011ab0b1dedb?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) it took him quite a while to learn how to use GitHub Copilot productively. Meanwhile, a backend developer with 6 YOE shares that they are doing the same:
...
Stagnation. The top gripe. LLM technology hasn’t changed in more than a year, since the release of ChatGPT 4.0, and it’s not getting better.
[Approaches like RAG](https://substack.com/redirect/98f53b1f-f61c-42a9-b87a-f8869e221492?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o)can only bring so much improvement, according to a software architect of 15 years, and one with 20 YOE.GitHub Copilot is the “only” tool that works. Several people say Copilot is the only tool they’re not entirely dissatisfied with, after testing several. However, these developers add that Copilot gets suggestions wrong as often as it’s right, and that unless you’re in a rush, it’s better to write code without automated suggestions.
...
Degrades people’s problem-solving skills. “I worry the younger generation will become dependent on LLMs, and that their own critical thinking and problem-solving skills will diminish.” (DevOps engineer, 8 YOE) I’d add that older generations tend to underestimate how the next generation adapts.
[Our recent GenZ survey in this publication showed](https://substack.com/redirect/89a4697f-0463-4ebb-af32-8684976df921?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o)the new generation of talent is very capable; so we might need to worry less!
The below criticism is about the inevitable nature of LLMs, thanks to their architecture. LLMs are trained on a large corpus of textual training data, and then generate the next most likely token based on an output. Thanks to this architecture, they will perform worse when encountering scenarios that were not part of their training data, and are prone to hallucination. We previously covered [How LLMs like ChatGPT works – as shared by the ChatGPT team](https://substack.com/redirect/befe5831-a01e-4fb1-afd1-c866d8cbc9c8?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o).
...
This criticism makes sense given how LLMs are trained; most training data is open-sourced code. At the same time, technology used at larger companies is often home-grown, and so these tools need additional context to work optimally. This context could be provided via [RAG](https://substack.com/redirect/98f53b1f-f61c-42a9-b87a-f8869e221492?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) (we covered [more on RAG](https://substack.com/redirect/98f53b1f-f61c-42a9-b87a-f8869e221492?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o).) We also previously covered [how LLMs work and are trained](https://substack.com/redirect/befe5831-a01e-4fb1-afd1-c866d8cbc9c8?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o).
