---
subject: "Building MCP servers in the real world"
from: "The Pragmatic Engineer <pragmaticengineer+deepdives@substack.com>"
to: ""
date: 2025-12-09 16:52:37
...
The bottom of this article could be cut off in some email clients. [Read the full article uninterrupted, online.](https://substack.com/redirect/2e09a2d5-fb32-4b1f-8921-3691d76cd964?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o)
The MCP protocol [was released](https://substack.com/redirect/742131ac-b63f-4004-8c85-71ee7c8a5083?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) in November 2024 and was developed by two software engineers at Anthropic, David Soria Parra, and Justin Spahr-Summers, who started work on it that July.
...
We cover the origin of MCP and how it works in depth, in the deepdive [MCP Protocol: a new AI dev tools building block](https://substack.com/redirect/f50ea378-564b-4f91-88b4-303910dd11f2?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o).
...
My colleague recently said that he thinks that MCP will replace ‘Self-service Business Intelligence.’ This replacement is especially likely once there’s a really established way to just build dashboards from what comes out of it. It’s almost like the promise of
[The Semantic Layer]in the data world is actually being realized through MCP in a way that never quite got out of the barn”.
...
Confluence MCP: “We use it to search for relevant documentation, update JIRA tasks, and read descriptions to bootstrap work.” –
[Lukas Kurucz](https://substack.com/redirect/a77da913-5d34-4c74-b26c-6ec47001d9cc?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o), React Native engineer at language learning platform Preply.Atlassian + GitHub + Confluence MCP: also from Lukas, a case of MCPs working together: “I use Atlassian MCP to create new documentation for changes based on PR on GitHub. Copilot will read code changes via GitHub MCP and create a doc on the changes in Confluence”.
Figma MCP is a popular mention among devs in our research, with several using it to turn Figma designs into code. Figma offers [a hosted remote server](https://substack.com/redirect/7b4a1480-5f9d-4f40-af8f-25cfebb4b51a?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o), and [a local server](https://substack.com/redirect/2a4b8a5b-c85f-4214-8671-288ce0e374a0?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) that can be used with the Figma desktop app:
...
“Chrome DevTools has powerful
[automation capabilities]like recording and replaying user flows, getting performance insights, and doing advanced browser debugging like analyzing network requests on the fly. However, until recently, only a small portion of people familiar with UI automation could utilize this.Thanks to
[chrome-devtools-mcp], now backend developers and even product managers can quickly experience its capabilities”.
New way of testing features? Software engineer, [Theo Windebank](https://substack.com/redirect/4abfe0d1-65f7-46fa-831d-b221e8137668?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o), described an interesting, new type of testing workflow at customer ops AI startup, Gradient Labs. It involves using a Notion database, Claude Code, and the Linear MCP:
...
Mobile QA with the iOS Simulator MCP: an interesting use case was shared by Staff Engineer Joshua Yoes, using the popular [iOS Simulator MCP](https://substack.com/redirect/3397c200-34cd-48b2-9fe2-f8f481283d3f?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) he created:
...
Context7 MCP: a popular way to access external documentation. [Context7 MCP](https://substack.com/redirect/51ed9fc3-c3e9-4b41-83d7-2b3f02259e12?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) was mentioned by several devs as the way they give agents access to up-to-date documentation:
“Context7 is a great tool for allowing the model to quickly fetch documentation about a tool”. — Federico Saravia, Head of Engineering at
[letsmake.com].“On my team we use Context7 for up-to-date documentation, and see fewer hallucinated APIs and functions as a result”. — Wynand Pieters, consultant dev.
“We usually use Context7 to give external documentation access to agents”. – Andrew Eacott, Principal Engineer at Miro.
[AWS Knowledge MCP server](https://substack.com/redirect/7d588dc2-1016-4641-8657-05107b67933c?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) is also handy, according to a software engineer at an autonomous driving startup:
“We use the Remote AWS Knowledge MCP via
[Streamable HTTP], proxied to standard input/output (stdio) for editor compatibility”.
...
“We built an internal tool that serves DevEx knowledge (how-to guides, internal library documentation) to engineers working in agentic coding IDEs. It was very straightforward to build; we used
[Spring AI]. The challenge is in optimising content served, not the MCP integration itself.” — Andrew Eacott, Principal Engineer at Miro“I’ve built an MCP sharing information about our internal libraries: it suggests what internal library to use, lists all libraries, provides documentation of a library, and provides examples of use of a library”. — software engineer at a startup
...
A software engineer at an electric aviation company built an MCP server to pull data from complicated, legacy [Siemens Polarion ALM](https://substack.com/redirect/ca7a7649-26a7-462a-910c-a2597c9426f1?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) software:
...
Kamlesh Chandnani is Director of Frontend at payment solutions provider, Razorpay. He shared how they’ve [open-sourced](https://substack.com/redirect/def97172-e497-4d0d-931b-e4af6058e932?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) their design system called ‘Blade’, and built [an MCP server](https://substack.com/redirect/8bd3493f-3596-41de-8b71-003afbb66b97?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) that can implement frontend UIs using this design system. The MCP server is also open source:
...
75% accuracy on the first generation, without prompting (we measure this using
[evals](https://substack.com/redirect/b8f7912b-9ac6-4ae2-81f9-431f178d585e?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o)). Devs iterate on the rest.3x: devs reported shipping three times faster when building UIs from Figma designs.
