---
subject: "Inside Google’s Engineering Culture: the Tech Stack (Part 2)"
from: "The Pragmatic Engineer <pragmaticengineer+deepdives@substack.com>"
to: ""
date: 2025-09-30 16:17:14
...
In [Part 1](https://substack.com/redirect/e4ef3063-6d8f-4605-9747-156bbc45a1a5?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o), we covered Google’s engineering and manager levels, compensation philosophy, hiring processes, and touched on what makes the company special. Today, we dig into the tech stack because one element that undoubtedly makes the company stand out in the industry is that Google is a tech island with its own custom engineering stack.
We cover:
...
The bottom of this article could be cut off in some email clients. [Read the full article uninterrupted, online.](https://substack.com/redirect/4157f920-4878-4f60-8397-8a0545f2e6dd?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o)
Google’s infrastructure is distinct from every other tech company because it’s all completely custom: not just the infra, but also the dev tools. Google [is a tech island](https://substack.com/redirect/5f7a5300-4d21-40b2-931a-e97bf5a2f780?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o), and engineers joining the tech giant can forget about tools they’re used to – GitHub, VS Code, Kubernetes, etc. Instead, it’s necessary to use Google’s own version of the tool when there’s an equivalent one.
Internally, Google engineers say “planet scale” as the company’s capacity to serve every human on Earth. All its tooling operates at global scale. That’s in stark contrast to Google Cloud Platform (GCP), with no such “planet-scale” deployment options built in – it’s possible to build applications that can scale that big, but it would be a lot of extra work. Large GCP customers which managed to scale GCP infrastructure to planetary proportions include Snap, which uses [GCP and AWS](https://substack.com/redirect/f25f5446-9239-4009-a805-a447a871e235?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) as their cloud backend, and Uber that uses [GCP and Oracle](https://substack.com/redirect/8a666636-b803-480a-90bf-0fb520e630e8?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o), as detailed in [Inside Uber’s move to the cloud](https://substack.com/redirect/8a666636-b803-480a-90bf-0fb520e630e8?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o).
...
As an aside, the roots of database [Planetscale](https://substack.com/redirect/b4be4471-b59d-408f-aa71-11c8c652a0ec?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) (the database Cursor [currently runs on](https://substack.com/redirect/a846ad6d-a699-4d2f-972d-55c6717cfb53?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o)) run to Google, and its “planet-scale” systems. Before co-founding Planetscale, [Sugu Sougoumarane](https://substack.com/redirect/3d0c1ec6-8d68-4490-a400-6c6b85f9f262?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) worked at Google on YouTube, where he created Vitess, an open source database to scale MySQL. Sugu now works on [Multigres](https://substack.com/redirect/e93415c0-8974-4a01-ac46-64a65a98aa7e?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o), an adaptation of Vitess for Postgres. I asked where the name Planetscale comes from. He said:
“The first time I heard the term ‘planet-scale’ was at Google. I chuckled a bit when I heard it because it’s not possible to build a globally-distributed
[ACID]database without trade-offs. But then, Vitess was already running at “planet-scale” at YouTube, with data centers in every part of the world.So, when we decided to name PlanetScale; it was a bold claim, but we knew Vitess could uphold it.”
...
For example, the internal version of
[GCP’s Pub/Sub]is called GOOPS (Google Pub/Sub). To configure GOOPS, you could not use the nice GCP UI: you needed to use a config file. Basically, external customers of GCP Pub/Sub have a much better developer experience than internal users.”
It makes no sense to use a public GCP service when there’s one already on PROD. Another Google engineer told us the internal version of [Spanner](https://substack.com/redirect/79317336-54c6-42fa-a71f-7c1870118393?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) (a distributed database) is much easier to set up and monitor. The internal tool to manage Spanner is called Spanbob, and there’s also an internal, enhanced version of SpanQSL.
...
Google stores all code in one repository called the monorepo – also referred to as “Google3”. The size of the repo is staggering – here are [stats from 2016](https://substack.com/redirect/8a64387a-0637-4ab2-a4a4-8e61d8c6b964?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o):
...
[Android](https://substack.com/redirect/f1c2cf29-fd6e-4775-8263-894d727b8ec0?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o): Google’s smartphone operating system[Chromium](https://substack.com/redirect/b3d5eeba-352d-4275-af29-bef876448103?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o): Google’s open source web browser. Google Chrome, Microsoft’s Edge, Opera, Brave, DuckDuckGo Browser and many others are built on top of Chromium.[Go](https://substack.com/redirect/9fc148c9-0b5b-4317-932e-ae1401e0d0dc?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o): the backend programming language created by Google
...
For example, here’s [an older documentation example](https://substack.com/redirect/a48a02ec-12b8-45e3-b761-8c25aaa18c91?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) where the source code is in a separate GitHub repository file to avoid Google’s readability review. For newer examples [like this one](https://substack.com/redirect/f627944b-f5e4-45c9-b6ae-289add960689?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o), code is written directly into the documentation file which is set up to not trigger a readability review.
...
In 2016, Google engineering manager Rachel Potvin [explained](https://substack.com/redirect/c2e340fe-8396-44dd-9c62-936414f8c978?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) that despite the monorepo, Google’s codebase was not monolithic. We asked current engineers there if this is still true, and were told there’s been no change:
...
Another Big Tech that has been using a monorepo since day one [is Meta](https://substack.com/redirect/dea83a8a-20c7-458f-883b-85b21af3fe87?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o). We covered more on its monorepo in [Inside Meta’s engineering culture.](https://substack.com/redirect/dea83a8a-20c7-458f-883b-85b21af3fe87?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o)
...
YouTube used to be a Python monolith, but later was rewritten in C++ and Java. Years ago, every release
[had](https://substack.com/redirect/58d817e9-7f5a-4eb4-b2c4-570c2179dee4?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o)a 50-hour manual release testing cycle run by a remote QA team.Google Search is the largest and most monolithic codebase. It’s the exception not the rule to have monolithic codebases.
Ads and Cloud are using ever more (micro)services.
Rewriting services for microservices is an approach Google uses in some cases. Rewriting an app from scratch as microservices (to establish the right level of modularity)
[is less effort](https://substack.com/redirect/f2232eca-e1e5-4d60-9597-53a90e792a16?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o)than breaking up the monolith.
...
[Google Java style](https://substack.com/redirect/e3f40249-fa90-4373-8f4a-fda14d1871e5?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o)– the[Google Java format tool](https://substack.com/redirect/7aa428e8-5e56-4dd0-a311-dc25199c3cfb?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o)formats code to be compatible with this style
Protobuf is Google’s approach to interoperability, [which](https://substack.com/redirect/b40fdced-117f-4f26-8fe5-a77a33abb2b7?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) is about working across programming languages. [Protobuf](https://substack.com/redirect/46e97c9f-173d-42ce-8d05-8965b3f928c8?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) is short for “Protocol buffers”: a language-neutral way to serialize structured data. Here’s an example protobuf definition:
edition = “2024”;
message Person {
string name = 1;
int32 id = 2;
...
[gRPC](https://substack.com/redirect/b43d305f-6f8d-47f3-bb22-490944155d40?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) is a modern, open source, high-performance remote procedural call (RPC) framework to communicate between services. Google open sourced and popularized this communication protocol, which is now a popular alternative to [REST](https://substack.com/redirect/e06c0d2c-ad6f-45f7-a998-81f9bd759878?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o). The biggest difference between REST and gRPC is that REST uses HTTP for human-readable formatting, while gRPC is a binary format and outperforms REST with smaller payloads and less serialization and deserialization overhead. Internally, Google services tend to communicate using the “Google internal gRPC implementation” called Stubby, and to not use REST.
