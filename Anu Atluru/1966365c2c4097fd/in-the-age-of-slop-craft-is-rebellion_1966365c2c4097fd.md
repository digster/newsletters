---
id: "1966365c2c4097fd"
subject: "In the age of slop, craft is rebellion"
from: "Anu from Working Theorys <anu@substack.com>"
to: ""
date: 2025-04-23 16:02:49
...
|
A while back, I [said](https://substack.com/redirect/864b948a-f36c-4159-b89c-4a43c471d623?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) I’d be experimenting with new ways to share what I’m thinking about, what I’m tinkering with, and conversations I’m having.
The Craft is one such experiment — a multi-format series I’m exploring here, all about the art of making things well. For this edition, I grabbed coffee with [Neal Agarwal](https://substack.com/redirect/38ab4d95-7c4d-4675-bb41-d8e343cb383c?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o), the indie game artisan behind [Neal.fun](https://substack.com/redirect/1e5c34f2-908b-4e83-86b7-f577fec6a655?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o), a cult-favorite corner of the internet home to [weird](https://substack.com/redirect/462f5045-7847-4b16-80de-0f166e1e8624?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o),[ delightful](https://substack.com/redirect/21460bc6-8aa3-4fd0-99ce-ea9b66b85ee6?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o), wildly viral games like The Password Game and Infinite Craft.
...
I made my first website when I was about 10 using
[Microsoft Frontpage], it was a collection of links to my favorite flash games I played in school. I started making my own games when I found[Scratch], and that was my first real foray into programming and making something and putting it out into the world.The first game I ever made was based on the British TV show
[Wipeout]. It was a platformer where each level was an obstacle course. The game is actually still up[here]! I love that kids are still commenting on it (“this is a great game! But what would make it even better is the OG Wipeout music.”)
...
As a teenager I started getting really into data visualizations. I made one called
[everysecond.io], which tracked how many iPhones, iPads, etc. Apple sold. It was my first website to gain some traction. A couple media outlets wrote about it, and I remember thinking, “Oh, that’s cool.” In high school, I made another site called[kamogo.com], a mix between[XKCD]and the stuff I do now. I called them interactive comics because the jokes were in the UI interactions.Looking back, it was the same ethos as
[The Password Game]: the UI itself as a medium for telling jokes. There were lots of other blogs/comic sites I loved, like[The Oatmeal]and[Wait But Why]. I spent most of school daydreaming about side projects. I knew I wanted to be making stuff on the web.
...
Each side project I made up to that point had a different domain. I don’t know how many domains I had, but it was way too many. Eventually, my parents were like, you’ve got to stop buying these domains because it’s adding up every year. So I bought
[Neal.fun]and just put everything there. That’s when my projects really started gaining traction because now everything was in one place.
...
Yeah, one job at a company called
[MSCHF]. I joined as a programmer. Every MSCHF drop needed its own website, so I worked across a lot of projects. Sometimes the website itself was the drop.
It was honestly a great fit for me, probably one of few jobs I could hold down. It was never boring, every month you were working on something different and completely insane. You would get a slack DM like, hey
[we’re gonna make a gun buyback program where we take your gun and melt it down to a sword], can you make a website for that. I loved how MSCHF saw the web like a creative medium like I did. I also thought it was funny that I spent most of my childhood trying to mess with adults, and now my first job was doing basically the same thing. It made the angsty-teenage side of me very happy.
For about a year and a half. I worked on about a third of drops while there, and the sneaker websites too. I’m really fond of
[tontine.cash], a graveyard game where you have to keep logging in every day to win the grand prize, and[Deep Fried Web], a chrome extension that just deep fried every website.
...
For me, making games is about creative expression. I want to try to add something new and interesting to the world. I want to try to add my voice and experiences to the mix.
Some of the AI tools are cool, but I’m not as interested in just making things cheaper and faster, although it can be nice to not have to manually code a modal for the x-millionth time.
The thing that excites me more about AI is when you can make something you couldn’t make before. Like with Infinite Craft — there were obviously crafting games before but the only way to make it truly endless is with AI. I find that a lot more interesting.
...
[Amusing Ourselves to Death]by Neil Postman, about how TV actually probably did rot our brains. I really liked your essay on making “heavy things” — that’s something I’ve been thinking about too.
...
The main thing for me is trying to stay in the middle of that
[ikigai circle]. I want the site to grow, but never at the expense of me enjoying what I’m doing. If that means the site doesn’t grow as fast, that's perfectly fine by me.
...
Easy,
[you need to win the lottery.](Narrator: this is worth the watch, start at 10:15 if you want to skip the long but charming metaphor. The short answer: take more shots).
...
Oh man. I don't even know what my next month will look like. Have you seen George R. R. Martin's interview where he talks about
[architects vs. gardeners]?Basically, there are authors who outline their entire book before writing the first chapter, and there are others who just let the story play out however it does while writing. I’m definitely in the “gardener” group. Even with projects, I have the seed for an idea, but I have no idea where it's gonna go. I generally know the next project, but the one after that, no clue. Same with my life.
Right now I’m working on a
[sequel to the password game that will be about captchas]. After that, I kind of want to make something paid, even if it’s just a $3 downloadable thing, potentially a foray into a desktop application.
...
You can find Neal on [X (Twitter)](https://substack.com/redirect/38ab4d95-7c4d-4675-bb41-d8e343cb383c?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o), his personal [website](https://substack.com/redirect/b7c15f04-1c60-45d2-b8f8-d96e13346861?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o), at his home on the web, [Neal.fun](https://substack.com/redirect/1e5c34f2-908b-4e83-86b7-f577fec6a655?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o). Check out his latest release, [Stimulation Clicker](https://substack.com/redirect/d2ac5696-e3a6-4268-acc0-fff47d08ffa8?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o), and the mobile version of his viral hit, Infinite Craft, on [iOS](https://substack.com/redirect/93ea4619-0c65-458d-9f14-fb87135cc9df?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o) and [Android](https://substack.com/redirect/90133639-2581-4f2f-abbf-28b293b7c4c2?j=eyJ1IjoiOG81NG4ifQ.6oeetudtJEh-zO1onUJvtadWEdbodFIw0h4xbugrh1o).
And if you enjoyed this, consider sharing with a friend or community that might enjoy it too.
Become a paying subscriber of Working Theorys to get access to this post and other subscriber-only content.
| Public, private, & experimental posts. | |
